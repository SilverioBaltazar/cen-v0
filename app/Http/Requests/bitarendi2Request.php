...
class bitarendi2Request extends FormRequest
{
    public function messages()
    {
        return [
            'bitaco_foto2.required' => 'El documento de bitacora de rendimiento de combustible 2 en formato PDF es obligatorio'
        ];
    }
    /**
