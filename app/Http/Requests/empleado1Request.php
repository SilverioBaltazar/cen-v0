...
class empleado1Request extends FormRequest
{
    public function messages()
    {
        return [
            ...
            'emp_foto1.required' => 'Formato de solicitud es obligatorio formato PDF'
        ];
    }
    /**
    ...
    {
        return [
            'emp_foto1'  => 'sometimes|mimetypes:application/pdf|max:2048',
            'emp_foto1'  => 'sometimes|mimetypes:pdf|max:2048',
            'emp_foto1'  => 'sometimes|mimes:application/pdf|max:2048',
            'emp_foto1'  => 'sometimes|mimes:pdf|max:2048'             
        ];
    }
}
