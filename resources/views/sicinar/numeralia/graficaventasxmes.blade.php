...
@section('title','Estadística de ventas por mes')
  ...
  <div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Estadísticas - Ventas - Por mes </a></li>
              ...
              <table id="tabla1" class="table table-striped table-bordered table-sm">
                <thead style="color: brown;" class="justify">
                    <tr>
                        ...
                        <th rowspan="2" style="text-align:center;">TOTAL<br>VENTAS  </th>
                        <th rowspan="2" style="text-align:center;">TOTAL<br>FCTURAS </th>                        
                    </tr>
                </thead>
                <tbody>
                    @foreach($regfactura as $factura)
                    <tr>
                        <td style="color:darkgreen;">{{$factura->mes_id}}</td>
                        <td style="color:darkgreen;">{{$factura->mes}}   </td>
                        <td style="color:darkgreen; text-align:center;">{{number_format($factura->totventas,2)}}</td>
                        <td style="color:darkgreen; text-align:center;">{{$factura->totfacturas}} </td>
                    </tr>
                    @endforeach
                    @foreach($totventasxmes as $totales)
                    <tr>
                        <td></td>
                        <td style="color:green;"><b>TOTALES</b></td>                         
                        <td style="color:green; text-align:center;"><b>{{number_format($totales->totalventasxmes,2)}} </b></td> 
                        <td style="color:green; text-align:center;"><b>{{$totales->totalfactxmes}}   </b></td> 
                    </tr>
                    @endforeach
                </tbody>
              </table>
        ...
        var options = {
          ...
          axes: {
            x: {
              ...
              1: { side: 'top', label: 'Total de ventas x mes'} // Top x-axis.
            }
          },
          bar: { groupWidth: "50%" }
        };
