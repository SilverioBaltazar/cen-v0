...
@section('title','Estadísticas de cobranza por mes')
...
@section('content')
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>Menú
                <small> Estadísticas - Cobranza por mes</small>                
            </h1>
        </section>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-primary">
                        ...
                        {!! Form::open(['route' => 'graficacobranzaxmes', 'method' => 'POST','id' => 'graficacobranzaxmes', 'enctype' => 'multipart/form-data']) !!}
                        <div class="box-body">
                            <div class="row">
...
@section('request')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\filtro01Request','#graficacobranzaxmes') !!}
@endsection
