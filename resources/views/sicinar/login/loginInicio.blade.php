...
<body class="hold-transition">
  <img src="{{ asset('images/logo-cen.jpg') }}" border="0" width="130" height="60" style="margin-left: 200px;margin-right: 50%">
  <img src="{{ asset('images/logo-cen-gobmexico.jpg') }}" border="0" width="150" height="60">
  <!--
  <style type="text/css">
    body{
  ...
  <div class="login-box">
    ...
    <div class="login-logo">
      <h5 style="color:orange;"><b>SISTEMA DE CONTROL ADMINISTRATIVO <br>(SICOAD v.1)</b></h5>
    ...
    <div class="login-logo"><br>
      ...
      <h6 style="color:green;"><b>Campaña Educativa Nacional (CEN)</b></h6>
    </div>
  </div>
