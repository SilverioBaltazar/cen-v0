            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-success">
                        ...
                        {!! Form::open(['route' => ['actualizarBitarendi2',$regbitarendi->bitaco_folio], 'method' => 'PUT', 'id' => 'actualizarBitarendi2', 'enctype' => 'multipart/form-data']) !!}
                        <div class="box-body">
                            ...
                            <div class="row">    
                                @if (!empty($regbitarendi->bitaco_foto2)||!is_null($regbitarendi->bitaco_foto2))  
                                    <div class="col-xs-12 form-group">
                                        <label >Archivo 2 de bitacora de rendimiento de combustible en formato PDF</label>
                                        <label ><a href="/images/{{$regbitarendi->bitaco_foto2}}" class="btn btn-danger" title="Archivo 2 de bitacora de rendimiento de combustible en formato PDF"><i class="fa fa-file-pdf-o"></i>{{$regbitarendi->bitaco_foto2}}</a>
                                        </label>
                                    </div>   
                                    <div class="col-xs-12 form-group">
                                        <label >Actualizar Archivo 2 de bitacora de rendimiento de combustible en formato PDF</label>
...
@section('request')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\bitarendi2Request','#actualizarBitarendi1') !!}
@endsection
