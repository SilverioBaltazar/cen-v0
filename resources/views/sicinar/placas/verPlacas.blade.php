                    ...
                    <div class="box">
                        ...
                        <div class="page-header" style="text-align:right;">
                            ...
                            {{ Form::open(['route' => 'buscarPlaca', 'method' => 'GET', 'class' => 'form-inline pull-right']) }}
                                ...
                                <div class="form-group">
                                    {{ Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Unidad']) }}
                                </div>
                                <div class="form-group">
                                ...
                                <a href="{{route('exportplacasExcel')}}" class="btn btn-success" title="Exportar catálogo de placas a formato Excel"><i class="fa fa-file-excel-o"></i> Excel
                                </a>
